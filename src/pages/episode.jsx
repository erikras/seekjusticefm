...
export default withSiteData(withRouteData(({ content: episode, myURL, image, title, description }) => {
    return episode ? (<Box gap="medium">
          <Header content={episode} siteData={{
        title,
        description,
...
//# sourceMappingURL=episode.jsx.map